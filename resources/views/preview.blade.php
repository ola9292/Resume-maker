...
@section('content') --}}
<div style="width: 63.333333%; margin: 0 auto;">
    ...
    <h4 style="border-bottom: 1px solid #e6e6e6; font-size: 1.25rem; margin-bottom: 0;">Professional Experience</h4>
    <table style="width: 100%; margin-bottom: 0.2rem;">
    ...
    <h4 style="border-bottom: 1px solid #e6e6e6; font-size: 1.25rem; margin-bottom: 0.5em; page-break-before: auto;">Education</h4>
    <table style="width: 100%;">
